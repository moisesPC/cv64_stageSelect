...
typedef struct {
    u8 unk4[0x612B];
    SaveFileSlotState SaveState_game;
    u8 unk2[0x1B4];
    ...
    s16 map_ID;	                // 80389ee0
    s16 map_entrance_ID;
    Color8 map_fade_in_color;	// 80389ee4
...
extern some_struct D_80363AB8[2];
extern some_struct D_80383AB8;        // Should just be D_80363AB8[1]
